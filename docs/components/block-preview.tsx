...
import { BlockItem } from "@/config/blocks";
...
function PreviewPanelResponsive() {
  const { responsiveMode, setResponsiveMode, resizablePanelRef, block } =
    usePreviewPanel();
    ...
    <div className='h-7.5 px-1 hidden lg:flex border border-border rounded-md items-center gap-1.5'>
      <Button
        ...
        className={cn(
          ...
          responsiveMode === "desktop" && "bg-accent",
        )}
        title='Desktop view'
      ...
      <Button
        ...
        className={cn(
          "size-6 rounded-md p-0",
          responsiveMode === "tablet" && "bg-accent",
        )}
        title='Tablet view'
      ...
      <Button
        ...
        className={cn(
          "size-6 rounded-md p-0",
          responsiveMode === "mobile" && "bg-accent",
        )}
        title='Mobile view'
