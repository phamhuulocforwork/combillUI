  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center gap-4">
        <span className="w-32 font-medium text-sm">1 star review:</span>
        <StarRating value={1} readOnly />
      </div>

      <div className="flex items-center gap-4">
        <span className="w-32 font-medium text-sm">2.5 star review:</span>
        <StarRating value={2.5} readOnly />
      </div>

      <div className="flex items-center gap-4">
        <span className="w-32 font-medium text-sm">5 star review:</span>
