...
const ComponentCli = ({ name, toast }: { name: string; toast?: string }) => {
  ...
  const commands = {
    pnpm: `pnpm dlx shadcn@latest add ${process.env.NEXT_PUBLIC_APP_URL}/registry/${name}.json`,
    npm: `npx shadcn@latest add ${process.env.NEXT_PUBLIC_APP_URL}/registry/${name}.json`,
    yarn: `npx shadcn@latest add ${process.env.NEXT_PUBLIC_APP_URL}/registry/${name}.json`,
    bun: `bunx --bun shadcn@latest add ${process.env.NEXT_PUBLIC_APP_URL}/registry/${name}.json`,
  };
