...
const TextStyle = () => {
  return (
    <div className="flex justify-center items-center rounded-md text-slate-800 shadow-sm gap-4">
      <div className="flex h-full items-center">
        <div className="py-2 px-3 flex justify-center cursor-pointer bg-white relative hover:bg-slate-200 rounded-l-md border-slate-400 border border-r-transparent">
          <div className="absolute bg-slate-800 text-slate-50 px-4 items-center -top-[130%] h-full flex justify-center rounded-md after:absolute after:w-4 after:h-4 after:bg-slate-800 after:-bottom-1 after:rotate-45 after:z-10">
            <span className="flex items-center gap-2">
              <p className="z-20">Bold</p>
        ...
        <div className="py-2 px-3 cursor-pointer bg-white hover:bg-slate-200 rounded-r-md border-slate-400 border border-l-transparent">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 24 24"
            fill="currentColor"
