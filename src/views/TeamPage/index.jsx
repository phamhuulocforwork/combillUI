  ...
  const TEAM = [
    {
      ...
      role: 'Lead Developer',
      introduce: `Olivia is a seasoned software engineer with a passion
      for creating innovative and efficient solutions to
      complex problems.`,
    },
    {
      id: 2,
      ...
      introduce: `Ethan excels in crafting compelling marketing
      strategies and campaigns that resonate with our
      audience, driving brand visibility and engagement.`,
    },
    {
      id: 3,
      name: 'Maya Rodriguez',
      role: 'UX/UI Designer',
      introduce: `Maya is a creative and detail-oriented designer,
    ...
    },
    {
      ...
      introduce: `Alexander oversees our day-to-day operations,
      ensuring smooth workflow and efficiency across the
  ...
  return (
    <>
      <div className="flex flex-col gap-4 w-full bg-black min-h-screen h-fit text-slate-50">
        ...
        <main className="lg:bg-grid-pattern bg-none">
          <div className="container my-16  mx-auto space-y-6">
            <div className="space-y-6 px-4 md:px-0">
              ...
              <p className="text-slate-500 font-medium tracking-wide text-lg">
                Welcome to the team! We are a group of passionate Individuals
                working together to achieve our goals.
                <p>Get to know the faces behind our success.</p>
              </p>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 font-medium gap-8 px-4 md:px-0">
              {TEAM.map((mem) => (
                <div
                  key={mem.id}
                ...
                >
                  ...
                  <div className="p-6 space-y-4">
                    <h2 className="text-2xl">{mem.name}</h2>
                    <h3 className="text-xl">{mem.role}</h3>
                    <p className="text-slate-500">{mem.introduce}</p>
